...
<script>
var countDownDate = new Date("april 30, 2020 23:00:00").getTime();
...
<div id="formSet">
  ...
  <form method="POST" action="images.php" enctype="multipart/form-data">
      ...
      <p style="background-color: #f1f1f1; width: 90%; text-align: center; height: 30px; border-radius: 10px; position: relative; left:50px;top:-50px;">(CLICK ON) Choose RIGHT OR LEFT IMAGE as most Skilful and Worthful OR Next</p>   
        <div id="comments">
